...
export default async function VehicleDetailPage({ params }: VehiclePageProps) {
  ...
  return (
    <main className="min-h-screen bg-gray-50/50 pt-24 pb-20 lg:pt-28 lg:pb-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="overflow-hidden rounded-[--radius-2xl] border border-gray-100 bg-white shadow-xl shadow-black/5">
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="relative flex flex-col justify-between bg-gradient-to-b from-gray-900 via-midnight to-black p-6 sm:p-8 lg:col-span-7 lg:p-12">
              ...
              <div className="relative my-8 aspect-[16/10] w-full overflow-hidden rounded-xl">
                {vehicle.imageUrl ? (
                  <Image
              ...
              {/* Quick Specs Strip */}
              {features && (
                <div className="relative z-10 grid grid-cols-4 gap-2 rounded-xl bg-white/5 p-4 backdrop-blur-md border border-white/10 text-white text-center">
                  <div>
                    <Users className="mx-auto h-4 w-4 text-gold mb-1" />
                    <p className="text-xs text-gray-400">Seats</p>
                    <p className="text-sm font-semibold">{features.seats}</p>
                  </div>
                  <div>
                    <Cog className="mx-auto h-4 w-4 text-gold mb-1" />
                    <p className="text-xs text-gray-400">Gearbox</p>
                    <p className="text-sm font-semibold">{features.transmission}</p>
                  </div>
                  <div>
                    <Fuel className="mx-auto h-4 w-4 text-gold mb-1" />
                    <p className="text-xs text-gray-400">Fuel</p>
                    <p className="text-sm font-semibold">{features.fuelType}</p>
                  </div>
                  <div>
                    <Briefcase className="mx-auto h-4 w-4 text-gold mb-1" />
                    <p className="text-xs text-gray-400">Luggage</p>
                    <p className="text-sm font-semibold">{features.luggage} Bags</p>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col justify-between p-6 sm:p-8 lg:col-span-5 lg:p-10">
              <div>
                ...
                <h1 className="mt-2 text-2xl font-display font-bold tracking-tight text-foreground sm:text-3xl lg:text-4xl">
                ...
                <div className="mt-6 rounded-xl bg-gray-50 p-5 border border-gray-100">
                  <p className="text-xs text-muted-foreground">Daily Hire Rate</p>
                  <div className="mt-1 flex items-baseline gap-2">
                    <span className="text-3xl font-display font-extrabold text-foreground sm:text-4xl">
                      ₹{vehicle.dailyRate}
                    </span>
                    <span className="text-sm font-medium text-muted-foreground">INR / day</span>
                  </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-3">
          {/* Specifications Card */}
          <div className="rounded-[--radius-xl] border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <dl className="mt-4 divide-y divide-gray-100 text-sm">
              ...
              <div className="flex justify-between py-2.5">
                ...
                <dd className="font-medium text-foreground">{vehicle.category}</dd>
              </div>
              {features && (
                <>
                  <div className="flex justify-between py-2.5">
                    <dt className="text-muted-foreground">Transmission</dt>
                    <dd className="font-medium text-foreground">{features.transmission}</dd>
                  </div>
                  <div className="flex justify-between py-2.5">
                    <dt className="text-muted-foreground">Fuel Type</dt>
                    <dd className="font-medium text-foreground">{features.fuelType}</dd>
                  </div>
                  <div className="flex justify-between py-2.5">
                    <dt className="text-muted-foreground">Seating Capacity</dt>
                    <dd className="font-medium text-foreground">{features.seats} Adults</dd>
                  </div>
                  <div className="flex justify-between py-2.5">
                    <dt className="text-muted-foreground">Luggage Capacity</dt>
                    <dd className="font-medium text-foreground">{features.luggage} Large Cases</dd>
                  </div>
                </>
              )}
            </dl>
          ...
          <div className="rounded-[--radius-xl] border border-gray-100 bg-white p-6 shadow-sm">
            <h3 className="text-lg font-display font-bold text-foreground">Key Features & Tech</h3>
          ...
          {/* Rental Terms Card */}
          <div className="rounded-[--radius-xl] border border-gray-100 bg-white p-6 shadow-sm">
            <h3 className="text-lg font-display font-bold text-foreground">Rental Conditions</h3>
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-2.5">
                <Clock className="h-4 w-4 text-gold flex-shrink-0 mt-0.5" />
                <span>
                  <strong className="text-foreground">Minimum Age:</strong> 21 years with open
                  driver licence.
                </span>
              </li>
              <li className="flex items-start gap-2.5">
                ...
                <span>
                  <strong className="text-foreground">Deposit:</strong> Refundable security bond
                  authorized on credit card upon collection.
                </span>
              </li>
              <li className="flex items-start gap-2.5">
                <MapPin className="h-4 w-4 text-gold flex-shrink-0 mt-0.5" />
                <span>
                  <strong className="text-foreground">Pickup Location:</strong> Available across
